...
namespace DynamicIidSpikeDetector
{
    class Program
    {
        class IidSpikeData
        ...
        static void Main(string[] args)
        {
            ...
            var arguments = new IidSpikeDetector.Arguments()
            {
            ...
            var transformedData = new IidSpikeEstimator(ml, arguments).Fit(dataView).Transform(dataView);
